...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiAppTestReqSql.Platforms.Android.DangerousTrustProvider+DangerousTrustManagerFactory, MauiAppTestReqSql", DangerousTrustProvider_DangerousTrustManagerFactory.class, __md_methods);
	}
	...
	public DangerousTrustProvider_DangerousTrustManagerFactory ()
	{
		...
		if (getClass () == DangerousTrustProvider_DangerousTrustManagerFactory.class) {
			mono.android.TypeManager.Activate ("MauiAppTestReqSql.Platforms.Android.DangerousTrustProvider+DangerousTrustManagerFactory, MauiAppTestReqSql", "", this, new java.lang.Object[] {  });
		}
	}

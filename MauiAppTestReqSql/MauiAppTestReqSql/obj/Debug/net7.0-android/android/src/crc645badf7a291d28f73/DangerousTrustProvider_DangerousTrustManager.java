...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiAppTestReqSql.Platforms.Android.DangerousTrustProvider+DangerousTrustManager, MauiAppTestReqSql", DangerousTrustProvider_DangerousTrustManager.class, __md_methods);
	}
	...
	public DangerousTrustProvider_DangerousTrustManager ()
	{
		...
		if (getClass () == DangerousTrustProvider_DangerousTrustManager.class) {
			mono.android.TypeManager.Activate ("MauiAppTestReqSql.Platforms.Android.DangerousTrustProvider+DangerousTrustManager, MauiAppTestReqSql", "", this, new java.lang.Object[] {  });
		}
	}
